...
- Видеоплатформа которая позволяет создавать, распространять, смотреть видео контент без цензуры `свобода распространения информации такой какая она есть`
- получать доход напрямую от рекламной сети, донаты - без посредника, а значит без каких либо комиссий `расписать как работает монетезация` 
- создавать и участвовать в общественных каналах `что такое общественные каналы`
- добалять к видео контенту интерактивные приложения `как работают приложения`
- децентрализованая рекламная сеть, ты сам решаешь какую рекламу показывать в своих видео `как работает рекламная сеть`
- частная дискриминация, ты фильтруешь сам что смотреть или нет. `логика формирования фильтров`

# Зачем тебе X - медиа

- личный контроль на спамом или тролями в комментариях `что это, в чем проблема, как мы решаем эту проблему`
- невозможность блокировки контента `Как это работает и почему мы не можем на это повлиять`
- свобода выражения мысли `логика естественной цензуры`
- никакой модерации - тебе никто не указывает быть ролику или нет
- финансовая независимость, прозрачность транзакций `описать подробнее`

# Как это работает
- Основные технологии: IPFS, Blockchain, DHT, HLS, FFMPEG (Конвертр)
- Логика взаимодействия "Потребителя" 
- Логика взаимодействия "Создателя"
- Логика взаимодействия "Super Content Distributor"
- Логика взаимодействия всех типов между собой 
